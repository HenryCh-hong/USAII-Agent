...
const PHRASE_ROOTS = ["lib/mock", "lib/trajectory", "lib/web", "lib/research", "knowledge", "components", "app", "docs/submission"];
// Roots scanned for fabricated exact percentages (data/docs only).
const PERCENT_ROOTS = ["lib/mock", "lib/trajectory", "lib/web", "lib/research", "knowledge", "docs/submission"];
